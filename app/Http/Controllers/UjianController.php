...
class UjianController extends Controller
{
    ...
    public function start(Request $request)
    {
        ...
        if ($posisiVal === 'Lainnya') {
            ...
            $request->validate([
                 'posisi' => 'required|string|in:ACCOUNT PAYABLE (AP),ACCOUNT RECEIVABLE (AR),ACCOUNTING (A),ADMIN GUDANG (AG),Admin penjualan (SA),ADMIN PPIC (APP),ADMIN QC (AQC),ADMIN SCM (ASCM),General Affair (GA),HRD Payroll (HRP),HRD Recruitment (HRR),Job Planner (JPL),Kas kecil (KAS),Kepala Gudang (KG),MARKETING (M),QUALITY CONTROL ANALIS (QCA),Sales (SLS),Sales marketing (SMK),SCM-FG (SFG),Staff Import (SIM),Staff legal (SLG),Staff purchasing (SPU),Staff Sales Executive (SSE),Staff sekretaris (SS),Supervisor Sales (SPVS),Utility (UTL)',
            ]);
        }
        ...
        switch ($posisi) {
            ...
            case 'Supervisor Sales (SPVS)':
                return [
                    ...
                    'bagian_b' => [
                        1 => [
                            'judul' => "Studi Kasus 1 — Sales Menyalahkan Produksi",
                            'deskripsi' => "Selama tiga bulan terakhir penjualan turun 15%. Tim sales berdalih produksi lambat, barang tidak ready, pengiriman molor, dan kompetitor gesit.<br>
                            • Namun hasil audit menunjukkan: 60% order terlambat karena sales mengubah spesifikasi setelah SPK diterbitkan.<br>
                            • Banyak sales menjanjikan tanggal kirim tanpa konfirmasi ke PPIC.<br>
                            • Forecast penjualan hampir tidak pernah dibuat oleh departemen sales.",
                            'pertanyaan' => [
                                1 => "Menurut Anda, siapa yang paling bertanggung jawab?",
                                2 => "Data apa yang perlu dikumpulkan sebelum mengambil kesimpulan?",
                                3 => "Bagaimana cara menyelesaikan konflik antara Sales dan Produksi?",
                                4 => "SOP atau sistem apa yang perlu dibuat?",
                                5 => "Bagaimana Anda memastikan kejadian yang sama tidak berulang?"
                            ]
                        ],
                        2 => [
                            'judul' => "Soal 2 — Margin Terlalu Tipis",
                            'deskripsi' => "Salah satu sales berhasil mendapatkan order besar senilai Rp800 juta.<br>
                            • Namun setelah diperiksa, margin keuntungan hanya 3%.<br>
                            • Padahal standar keuntungan minimal perusahaan adalah 10%.",
                            'pertanyaan' => [
                                1 => "Apa yang akan Anda lakukan terhadap sales tersebut?",
                                2 => "Apakah order tersebut tetap diterima atau ditolak? Jelaskan alasannya secara finansial.",
                                3 => "Bagaimana cara mencegah kejadian serupa terulang kembali?"
                            ]
                        ],
                        3 => [
                            'judul' => "Studi Kasus 3 — Supervisor Baru Mengelola Tim Bermasalah",
                            'deskripsi' => "Anda baru diangkat menjadi Supervisor Sales. Kondisi tim Anda:<br>
                            <table class='table table-bordered table-sm mt-2' style='max-width: 400px; background: white;'>
                                <thead class='table-light'>
                                    <tr><th>Sales</th><th>Pencapaian Target</th></tr>
                                </thead>
                                <tbody>
                                    <tr><td>Sales A</td><td class='text-center'>140%</td></tr>
                                    <tr><td>Sales B</td><td class='text-center'>130%</td></tr>
                                    <tr><td>Sales C</td><td class='text-center'>110%</td></tr>
                                    <tr><td>Sales D</td><td class='text-center'>70%</td></tr>
                                    <tr><td>Sales E</td><td class='text-center'>65%</td></tr>
                                    <tr><td>Sales F</td><td class='text-center'>50%</td></tr>
                                </tbody>
                            </table>
                            <br>Fakta lainnya:<br>
                            • Sales A dan B mendominasi customer besar.<br>
                            • Sales D, E, F mengeluh wilayahnya sulit.<br>
                            • Tidak ada pembagian area yang jelas.<br>
                            • Customer dikunjungi lebih dari satu sales.<br>
                            • Terjadi perang harga internal sales.<br>
                            • Direktur meminta peningkatan penjualan 25% dalam 6 bulan tanpa menambah staf.",
                            'pertanyaan' => [
                                1 => "Identifikasi minimal 5 masalah utama dari kasus tersebut.",
                                2 => "Prioritas perbaikan apa yang akan Anda lakukan dalam 30 hari pertama?",
                                3 => "Apakah perlu dilakukan redistribusi customer dan wilayah? Jelaskan.",
                                4 => "KPI baru apa yang akan Anda terapkan?",
                                5 => "Bagaimana strategi mencapai kenaikan penjualan 25% tanpa menambah tenaga kerja?"
                            ]
                        ],
                        4 => [
                            'judul' => "Studi Kasus 4 — Analisis Data Penjualan",
                            'deskripsi' => "Berikut adalah data performa penjualan 3 bulan terakhir:<br>
                            <table class='table table-bordered table-sm mt-2' style='max-width: 400px; background: white;'>
                                <thead class='table-light'>
                                    <tr><th>Bulan</th><th>Omzet</th><th>Margin</th><th>Customer Aktif</th></tr>
                                </thead>
                                <tbody>
                                    <tr><td>Januari</td><td>Rp4,5 M</td><td class='text-center'>18%</td><td class='text-center'>120</td></tr>
                                    <tr><td>Februari</td><td>Rp5,0 M</td><td class='text-center'>15%</td><td class='text-center'>115</td></tr>
                                    <tr><td>Maret</td><td>Rp5,7 M</td><td class='text-center'>11%</td><td class='text-center'>98</td></tr>
                                </tbody>
                            </table>",
                            'pertanyaan' => [
                                1 => "Apa yang Anda lihat dari tren performa tersebut?",
                                2 => "Apa risiko yang akan muncul jika tren tersebut terus berlanjut?",
                                3 => "Apa kemungkinan penyebab penurunan customer aktif?",
                                4 => "Langkah korektif apa yang harus dilakukan?",
                                5 => "Jika Anda melaporkan data ini kepada Direktur, apa kesimpulan utama Anda?"
                            ]
                        ],
                        5 => [
                            'judul' => "Soal 5 — Kompetitor Menurunkan Harga",
                            'deskripsi' => "Kompetitor menawarkan harga 10% lebih murah kepada sebagian besar pelanggan perusahaan.<br>
                            • Beberapa customer mulai meminta diskon tambahan kepada sales Anda.",
                            'pertanyaan' => [
                                1 => "Apa tindakan taktis pertama yang akan Anda lakukan?",
                                2 => "Apakah solusi terbaik dalam menghadapi situasi ini selalu menurunkan harga? Jelaskan.",
                                3 => "Strategi apa yang dapat digunakan untuk mempertahankan customer tanpa merusak margin perusahaan?"
                            ]
                        ]
                    ]
                ];
            ...
            case 'Kepala Gudang (KG)':
                return [
                    ...
                    'bagian_b' => [
                        1 => [
                            'judul' => "Studi Kasus 1 — Selisih Stock Opname Besar",
                            'deskripsi' => "Saat dilakukan stock opname bulanan ditemukan selisih sebagai berikut:<br>
                            <table class='table table-bordered table-sm mt-2' style='max-width: 500px; background: white;'>
                                <thead class='table-light'>
                                    <tr><th>Barang</th><th>Stok Sistem</th><th>Stok Fisik</th><th>Selisih</th></tr>
                                </thead>
                                <tbody>
                                    <tr><td>Material A</td><td>15.000 Kg</td><td>13.800 Kg</td><td class='text-danger'>-1.200 Kg</td></tr>
                                    <tr><td>Material B</td><td>8.500 Kg</td><td>9.000 Kg</td><td class='text-success'>+500 Kg</td></tr>
                                    <tr><td>Material C</td><td>5.000 Kg</td><td>4.400 Kg</td><td class='text-danger'>-600 Kg</td></tr>
                                </tbody>
                            </table>
                            <br>Tim gudang beralasan:<br>
                            • Banyak transaksi yang belum diinput.<br>
                            • Barang sering dipinjam bagian produksi tanpa dokumen.<br>
                            • Admin gudang sedang cuti saat periode tersebut.",
                            'pertanyaan' => [
                                1 => "Apa langkah pertama yang akan Anda lakukan?",
                                2 => "Bagaimana cara mencari akar penyebab selisih tersebut?",
                                3 => "Data apa saja yang perlu diperiksa?",
                                4 => "Siapa saja yang perlu dilibatkan dalam investigasi?",
                                5 => "Sistem apa yang harus diperbaiki agar kejadian serupa tidak terulang?"
                            ]
                        ],
                        2 => [
                            'judul' => "Studi Kasus 2 — Produksi Berhenti Karena Material Habis",
                            'deskripsi' => "Mesin produksi berhenti selama 3 jam karena material utama habis. Fakta yang ditemukan:<br>
                            • Sistem masih menunjukkan stok tersedia.<br>
                            • Fisik barang ternyata kosong.<br>
                            • Gudang tidak pernah melakukan cycle count.<br>
                            • Pembelian baru mengetahui kekurangan stok setelah produksi berhenti.<br>
                            • Kerugian downtime diperkirakan Rp50 juta.",
                            'pertanyaan' => [
                                1 => "Menurut Anda siapa yang bertanggung jawab?",
                                2 => "Apa penyebab utama kejadian tersebut?",
                                3 => "Langkah darurat apa yang harus dilakukan?",
                                4 => "Bagaimana mencegah kejadian serupa?",
                                5 => "KPI apa yang harus diterapkan pada gudang?"
                            ]
                        ],
                        3 => [
                            'judul' => "Studi Kasus 3 — Gudang Penuh, Barang Sulit Dicari",
                            'deskripsi' => "Kondisi gudang saat ini:<br>
                            • Utilitas gudang mencapai 95%.<br>
                            • Banyak barang disimpan tidak sesuai lokasi.<br>
                            • Proses pencarian barang memakan waktu lama.<br>
                            • Sering terjadi keterlambatan pengiriman ke customer.<br>
                            • Direktur meminta perbaikan dalam waktu 2 bulan tanpa perlu memperluas gudang.",
                            'pertanyaan' => [
                                1 => "Identifikasi minimal 5 masalah utama.",
                                2 => "Prioritas perbaikan apa yang akan Anda lakukan?",
                                3 => "Bagaimana cara meningkatkan kapasitas gudang tanpa menambah bangunan?",
                                4 => "Sistem penyimpanan apa yang Anda usulkan?",
                                5 => "KPI apa yang digunakan untuk mengukur keberhasilan program tersebut?"
                            ]
                        ],
                        4 => [
                            'judul' => "Studi Kasus 4 — Dugaan Kehilangan Material",
                            'deskripsi' => "Dalam 6 bulan terakhir terjadi kehilangan material secara bertahap dengan nilai total Rp250 juta. Hasil audit menemukan:<br>
                            • Tidak ada CCTV di area tertentu.<br>
                            • Barang keluar hanya menggunakan instruksi lisan.<br>
                            • Pemeriksaan kendaraan keluar tidak dilakukan.<br>
                            • Kepala gudang menganggap kehilangan masih dalam batas wajar.<br>
                            • Direktur meminta investigasi menyeluruh.",
                            'pertanyaan' => [
                                1 => "Apa langkah investigasi yang Anda lakukan?",
                                2 => "Apa kelemahan kontrol yang paling berbahaya?",
                                3 => "Jika Anda menjadi Kepala Gudang, tindakan apa yang dilakukan dalam 30 hari pertama?",
                                4 => "Bagaimana sistem pengawasan yang ideal?",
                                5 => "Apakah kerugian tersebut dapat dianggap normal? Jelaskan."
                            ]
                        ],
                        5 => [
                            'judul' => "Studi Kasus 5 — Konflik Gudang dan Produksi",
                            'deskripsi' => "Produksi mengeluh karena material sering terlambat dikirim dari gudang. Gudang beralasan:<br>
                            • Permintaan material sering mendadak.<br>
                            • Dokumen pengambilan tidak lengkap.<br>
                            • Tenaga gudang terbatas.<br>
                            • Produksi berpendapat bahwa keterlambatan tersebut menyebabkan target produksi gagal tercapai.",
                            'pertanyaan' => [
                                1 => "Bagaimana Anda menentukan pihak yang benar?",
                                2 => "Data apa yang perlu dianalisis?",
                                3 => "Bagaimana menyelesaikan konflik ini?",
                                4 => "SOP apa yang perlu dibuat atau diperbaiki?",
                                5 => "Bagaimana membangun koordinasi yang lebih baik antara gudang dan produksi?"
                            ]
                        ],
                        6 => [
                            'judul' => "Studi Kasus 6 — Kinerja Tim Gudang Menurun",
                            'deskripsi' => "Dalam 3 bulan terakhir:<br>
                            • Akurasi stok turun dari 99% menjadi 93%.<br>
                            • Keterlambatan pengiriman meningkat.<br>
                            • Banyak lembur terjadi.<br>
                            • Tingkat kesalahan picking meningkat.<br>
                            • Tim gudang menyampaikan bahwa beban kerja meningkat dan beberapa karyawan baru belum memahami sistem kerja.",
                            'pertanyaan' => [
                                1 => "Apa analisis Anda terhadap kondisi tersebut?",
                                2 => "Bagaimana cara mengidentifikasi penyebab utama?",
                                3 => "Apa tindakan jangka pendek yan            case 'ADMIN GUDANG (AG)':
                return [
                    'bagian_a' => [],
                    'bagian_b' => [
                        1 => [
